            ...
            <div class="card-body">
                <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Format: JPG, PNG, GIF. Ukuran maks: 2MB.</small>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="card card-admin">
            ...
            <div class="card-body">
                <div class="text-center mb-3">
                    <img id="image-preview" src="https://via.placeholder.com/800x400?text=Banner+Preview" class="img-fluid rounded" alt="Preview">
                </div>
                <div class="text-center">
                    <h5 id="title-preview">Judul Banner</h5>
                    <p id="subtitle-preview" class="text-muted">Subjudul Banner</p>
                    <button id="button-preview" class="btn btn-primary">Lihat Detail</button>
                </div>
            </div>
        </div>
    </div>
